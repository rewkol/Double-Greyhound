...
public class PuppetSeabeeController : MonoBehaviour, IPuppet
{
    ...
    private IEnumerator AttackRoutine()
    {
        ...
        for (int i = 0; i < 42; i++)
        {
            transform.position += new Vector3(-0.02f, 0.1f, 0.0f);
            yield return new WaitForFixedUpdate();
        }
        ...
        while (transform.position.x > xBase)
        {
